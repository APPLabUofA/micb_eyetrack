...
% @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@  
            ...
            if isempty(exp.preocularthresh) == 0
                ...
                rejtrial(1,1).ids = find(EEG.reject.rejthresh==1);
            ...
            if isempty(exp.postocularthresh) == 0
                ...
                rejtrial(1,2).ids = find(EEG.reject.rejthresh==1);
                EEG.rejtrial = rejtrial;
            end
            % :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
% @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ 
            ...
            EEG = reject_trials_inspect(EEG,part_name,exp,rejtrial);
...
%                         end
                        ...
                        clear Filepath_Trials filename EEG

                    end
                    eeglab redraw
                end %i_set 2nd loop end
            end %create TF data loop end
            clear part_name
% ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::         
    end %i_part loop end
% :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: 
